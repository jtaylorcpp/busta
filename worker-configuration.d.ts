/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: decb967b223cabc9a5f879dbb7ae2676)
...
interface __BaseEnv_Env {
	...
	MAILBOX: DurableObjectNamespace<import("./web/src/worker").MailboxDO>;
	THREAD: DurableObjectNamespace<import("./web/src/worker").ThreadDO>;
	TENANT: DurableObjectNamespace<import("./web/src/worker").TenantDO>;
	IMPORT: DurableObjectNamespace<import("./web/src/worker").ImportDO>;
	VAULT: DurableObjectNamespace<import("./web/src/worker").GmailVaultDO>;
	PHONE: DurableObjectNamespace<import("./web/src/worker").PhoneDO>;
	LINK: DurableObjectNamespace<import("./web/src/worker").LinkDO>;
	ASK: DurableObjectNamespace<import("./web/src/worker").AskDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./web/src/worker");
		durableNamespaces: "MailboxDO" | "TenantDO" | "ThreadDO" | "ImportDO" | "GmailVaultDO" | "PhoneDO" | "LinkDO" | "AskDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAIL_DOMAIN" | "SEARCH_BODY_CHARS" | "STORAGE_HIGH_WATERMARK" | "STORAGE_LOW_WATERMARK" | "ARCHIVE_AFTER_DAYS" | "MAX_ATTACHMENT_BYTES" | "MAX_INBOUND_BYTES" | "MTA_STS_MODE" | "MTA_STS_MX" | "MTA_STS_MAX_AGE" | "FAULT_CODE" | "INLINE_ATTACHMENT_BYTES" | "DOWNLOAD_LINK_DAYS" | "CF_ZONE_ID" | "WORKER_NAME" | "AI_GATEWAY_ID" | "ADMIN_USER_IDS" | "GMAIL_PUBSUB_TOPIC" | "PUBSUB_PUSH_SA" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "ENVIRONMENT" | "THREAD_SECRET" | "PUBLIC_BASE_URL" | "CF_API_TOKEN" | "PUBLIC_CLERK_PUBLISHABLE_KEY">> {}
}
