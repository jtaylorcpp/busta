/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 046ad8f22ef3060cdb3f32e720c69feb)
...
interface __BaseEnv_Env {
	...
	PROVISION: Workflow<Parameters<import("./web/src/worker").MailboxProvisionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./web/src/worker");
		durableNamespaces: "MailboxDO" | "TenantDO" | "ThreadDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAIL_DOMAIN" | "SEARCH_BODY_CHARS" | "STORAGE_HIGH_WATERMARK" | "STORAGE_LOW_WATERMARK" | "ARCHIVE_AFTER_DAYS" | "MAX_ATTACHMENT_BYTES" | "MAX_INBOUND_BYTES" | "MTA_STS_MODE" | "MTA_STS_MX" | "MTA_STS_MAX_AGE" | "FAULT_CODE" | "INLINE_ATTACHMENT_BYTES" | "DOWNLOAD_LINK_DAYS" | "CF_ZONE_ID" | "WORKER_NAME" | "AI_GATEWAY_ID" | "ADMIN_USER_IDS" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "ENVIRONMENT" | "THREAD_SECRET" | "PUBLIC_BASE_URL" | "CF_API_TOKEN" | "PUBLIC_CLERK_PUBLISHABLE_KEY">> {}
}
